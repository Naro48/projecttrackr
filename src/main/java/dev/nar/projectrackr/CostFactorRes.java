...
public class CostFactorRes {
    public static Map<String, List<Double>> poids = Map.of("Very Low",
            List.of(0.75,null,0.70,null,null,null,null,1.46,1.29,1.42,1.21,1.14,1.24,1.24,1.23),
            "Low",
            List.of(0.88,0.94,0.85,null,null,0.87,0.87,1.19,1.13,1.17,1.10,1.07,1.10,1.10,1.08),
            "Nominal"
            ,List.of(1.0),
            "High",List.of(1.15,1.08,1.15,1.11,1.06,1.15,1.07,0.86,0.91,0.86,0.90
                    ,0.95,0.91,0.91,1.04),
            "Very High",List.of(1.40,1.16,1.30,1.30,1.21,1.30,1.15,0.71,0.82,0.70,null,null,0.82,0.83,1.10),
            "Extra High",
            List.of(null,null,1.65,0.015,1.56,null,null,null,null,null,null,null,null,null,null));
